...
# Set text
score_text = make_text(font, f"Score: {score}", GREEN, BLACK)
score_rect = score_text.get_rect()
score_rect.topleft = (10, 10)

title_text = make_text(font, "Feed the Dragon", GREEN, BLACK)
title_rect = title_text.get_rect()
title_rect.centerx = WINDOW_WIDTH // 2
title_rect.y = 10

lives_text = make_text(font, f"Lives: {player_lives}", GREEN, BLACK)
